...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .voice-circle-btn .voice-icon { font-size: 20px; }
        ...
        @media (max-width: 480px) {
            ...
            .voice-circle-btn { padding: 8px 16px; min-height: 40px; }
    ...
    <div class="chat">
        ...
        <div class="input-area">
            ...
            <div class="voice-panel">
                <button class="voice-circle-btn" id="voiceBtn" onclick="toggleVoice()">
    ...
    <script>
        ...
        async function startRecording() {
            try {
                ...
                document.getElementById('voiceBtn').querySelector('.voice-label').textContent = '⏹ Отпусти для отправки';
        ...
        document.getElementById('voiceBtn').addEventListener('touchmove', function(e) {
            if (isRecording) {
...
if __name__ == '__main__':
    ...
    print("📷 Отправка фото")
    print("🎤 Голосовые кружки (как в Telegram)")
    print("❤️ Реакции на сообщения")
    print("✏️ Редактирование и удаление")
